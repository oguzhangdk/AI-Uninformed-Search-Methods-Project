...
public class UninformedSearch {
    ...
    public List<Node> BreadthFirstSearch(Node root){
        ...
        while(OpenList.size() > 0 && !goalFound){ //+++
            ...
            //EĞER FRİNGE İÇİ DAHA BÜYÜKSE MAKSİMUM FRİNGE SİZE IM OLACAK
           ...
           //currentNode.PrintPuzzle(); /*Tüm current nodelardaki puzzle hali görmek için*/
            ...
            for(int i =0; i< currentNode.children.size();i++)
            {
                ...
                if(currentChild.GoalTest()){
                    ...
                    System.out.println("NUMBER OF NODES EXPANDED "+ClosedList.size());//FRİNGE'den çıkanlar expanded
           ...
           //currentNode.PrintPuzzle(); /*Tüm current nodelardaki puzzle hali görmek için*/
            ...
            for(int i =0; i< currentNode.children.size();i++)
            {
                ...
                if(currentChild.GoalTest()){
                    ...
                    System.out.println("NUMBER OF NODES EXPANDED "+ClosedList.size()); //FRİNGE'den çıkanlar expanded
                    System.out.println("MAXIMUM SIZE OF THE FRINGE " + maxSizeFringe); //EĞER GOAL FOUND BULUNURSA MAKSİMUM FRİNGE
